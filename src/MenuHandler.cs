...
namespace AokanaAccess
{
    ...
    public static class MenuHandler
    {
        ...
        private static Dictionary<string, Dictionary<string, string>> _buttonTranslations = new Dictionary<string, Dictionary<string, string>>
        {
            ...
            // Character voice mute buttons
            { "muteAsuka", new Dictionary<string, string> {
                { "cn", "明日香" },
                { "en", "Asuka" },
                { "jp", "明日香" },
                { "tc", "明日香" }
            }},
            { "muteMisaki", new Dictionary<string, string> {
                { "cn", "美咲" },
                { "en", "Misaki" },
                { "jp", "美咲" },
                { "tc", "美咲" }
            }},
            { "muteMashiro", new Dictionary<string, string> {
                { "cn", "真白" },
                { "en", "Mashiro" },
                { "jp", "真白" },
                { "tc", "真白" }
            }},
            { "muteRika", new Dictionary<string, string> {
                { "cn", "莉佳" },
                { "en", "Rika" },
                { "jp", "莉佳" },
                { "tc", "莉佳" }
            }},
            { "muteAoi", new Dictionary<string, string> {
                { "cn", "葵" },
                { "en", "Aoi" },
                { "jp", "葵" },
                { "tc", "葵" }
            }},
            { "muteShion", new Dictionary<string, string> {
                { "cn", "紫苑" },
                { "en", "Shion" },
                { "jp", "紫苑" },
                { "tc", "紫苑" }
            }},
            { "muteMadoka", new Dictionary<string, string> {
                { "cn", "圆" },
                { "en", "Madoka" },
                { "jp", "円" },
                { "tc", "圓" }
            }},
            { "muteShirase", new Dictionary<string, string> {
                { "cn", "白濑" },
                { "en", "Shirase" },
                { "jp", "白瀬" },
                { "tc", "白瀨" }
            }},
            { "muteMinamo", new Dictionary<string, string> {
                { "cn", "水波" },
                { "en", "Minamo" },
                { "jp", "水萌" },
                { "tc", "水萌" }
            }},
            { "muteShindou", new Dictionary<string, string> {
                { "cn", "新堂" },
                { "en", "Shindou" },
                { "jp", "新藤" },
                { "tc", "新堂" }
            }},
            { "muteSatouin", new Dictionary<string, string> {
                { "cn", "里院" },
                { "en", "Satouin" },
                { "jp", "里院" },
                { "tc", "里院" }
            }},
            { "muteMinori", new Dictionary<string, string> {
                { "cn", "明里" },
                { "en", "Minori" },
                { "jp", "実" },
                { "tc", "實" }
            }},
            { "muteBotan", new Dictionary<string, string> {
                { "cn", "牡丹" },
                { "en", "Botan" },
                { "jp", "牡丹" },
                { "tc", "牡丹" }
            }},
            { "muteSaki", new Dictionary<string, string> {
                { "cn", "纱希" },
                { "en", "Saki" },
                { "jp", "咲" },
                { "tc", "咲" }
            }},
            { "muteMayu", new Dictionary<string, string> {
                { "cn", "真夜" },
                { "en", "Mayu" },
                { "jp", "真夜" },
                { "tc", "真夜" }
            }},
            { "muteMasked", new Dictionary<string, string> {
                { "cn", "蒙面" },
                { "en", "Masked" },
                { "jp", "仮面" },
                { "tc", "蒙面" }
            }},
            { "muteKasumi", new Dictionary<string, string> {
                { "cn", "霞" },
                { "en", "Kasumi" },
                { "jp", "霞" },
                { "tc", "霞" }
            }},
            { "muteArika", new Dictionary<string, string> {
                { "cn", "有香" },
                { "en", "Arika" },
                { "jp", "有香" },
                { "tc", "有香" }
            }},
            { "muteIrina", new Dictionary<string, string> {
                { "cn", "伊莉娜" },
                { "en", "Irina" },
                { "jp", "イリーナ" },
                { "tc", "伊莉娜" }
            }},
            { "muteOther", new Dictionary<string, string> {
                { "cn", "其他" },
                { "en", "Other" },
                { "jp", "その他" },
                { "tc", "其他" }
